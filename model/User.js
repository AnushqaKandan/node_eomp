...
class Users {
    fetchUsers(req, res) {
        try{
            const strQry = `SELECT firstName, lastName, userage, Gender, userRole, emailAdd, userPass, userProfile FROM Users;`
...
fetchUser(req, res) {
    try {
        const strQry = `SELECT firstName, lastName, userage, Gender, userRole, emailAdd, userPass, userProfile
